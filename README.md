...
| `quality.html` | Certifications, B12 data, zero-carbon, export standards |
...
- Certificate names/issuers and lab report documents (Japan/US export standard, Halal, B12, carbon footprint)
