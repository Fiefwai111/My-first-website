...
| `quality.html` | Certifications, B12 data, zero E. coli (food safety), export standards |
...
- Certificate names/issuers and lab report documents (Japan/US export standard, Halal, Vegan, B12, E. coli) — see `ASSETS.md` for the certificate image filenames the site expects
